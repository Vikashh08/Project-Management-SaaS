...
const Login = () => {
  ...
  const isClerkLoaded = clerk?.isLoaded;
      ...
      <div className="max-w-md w-full bg-white dark:bg-[#131b2e] p-8 rounded-3xl shadow-xl border border-slate-200 dark:border-white/10 relative overflow-hidden">
        ...
        <div className="mb-5">
          <button
            ...
            className="w-full py-3 px-4 bg-white dark:bg-gray-800 border border-slate-200 dark:border-white/10 rounded-xl text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all flex items-center justify-center gap-3 cursor-pointer shadow-sm hover:shadow-md active:scale-[0.98]"
          >

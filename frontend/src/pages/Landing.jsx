...
import { 
  ...
  CheckSquare, Globe, ArrowUpRight, MessageSquare, Shield, Zap, LayoutDashboard, Search, X, Moon, Sun
} from 'lucide-react';
      ...
      <section className="relative pt-20 pb-28 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <a 
              href="#features"
              className="px-8 py-4 bg-white dark:bg-gray-900 text-gray-700 dark:text-gray-300 font-bold rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-800 border border-gray-200 dark:border-white/10 transition-all hover:-translate-y-0.5"
            >
              Explore Features
            </a>
          </motion.div>

    ...
    <div className="p-6 h-full overflow-y-auto">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 flex flex-col justify-center shadow-sm">
            ...
            <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2.5">
              <div 
                className="bg-gradient-to-r from-primary to-primary-light h-2.5 rounded-full transition-all duration-1000" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 lg:col-span-2 shadow-sm">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="text-sm text-text-muted bg-gray-100 dark:bg-gray-800 px-3 py-1 rounded-lg font-medium">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {project.members?.map(({ user }) => (
                <div key={user.id} className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30 hover:shadow-sm transition-shadow">
                  <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold overflow-hidden shrink-0 ring-2 ring-white dark:ring-gray-800">
                    {user.avatarUrl ? (
          ...
          {/* Quick Info */}
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 space-y-6 shadow-sm">
            <div>
              ...
              <div className="space-y-4 mt-4">
                <div>
                  <p className="text-xs text-text-muted font-medium mb-1.5 uppercase tracking-wider">Priority</p>
                ...
                <div>
                  <p className="text-xs text-text-muted font-medium mb-1.5 uppercase tracking-wider">Owner</p>
                  <div className="flex items-center gap-2 mt-1">
                    <div className="w-7 h-7 rounded-full bg-primary/10 flex items-center justify-center text-primary text-xs font-bold ring-2 ring-white dark:ring-gray-800">
                ...
                <div>
                  <p className="text-xs text-text-muted font-medium mb-1.5 uppercase tracking-wider">Created</p>
                  <div className="flex items-center gap-2 mt-1">
